...
def run_evaluation_task(self, document_id: str, project_id: str = None, run_extraction: bool = True, notes: str = None):
    """
    ...
    try:
        ...
        from uu_backend.models.evaluation import EvaluationRun
        ...
        logger.info(f"[CELERY] Evaluation completed, got {len(result.field_comparisons)} comparisons")
        ...
        evaluation_run = EvaluationRunModel.objects.create(
            ...
            instance_comparisons={
                k: [ic.model_dump() for ic in v]
                for k, v in result.instance_comparisons.items()
            },
