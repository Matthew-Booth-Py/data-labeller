...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['document_id', '-evaluated_at'], name='evaluation__documen_idx'),
        ),
        migrations.AddIndex(
            model_name='evaluationrunmodel',
            index=models.Index(fields=['project_id', '-evaluated_at'], name='evaluation__project_idx'),
        ),
        migrations.AddIndex(
            model_name='evaluationrunmodel',
