...
class BoundingBoxData(BaseModel):
    ...
    text: str | None = Field(None, description="Text content in bbox (if available)")
...
class TableRowFieldData(BaseModel):
    ...
    bbox: BoundingBoxData | None = Field(None, description="Bounding box for this field")
    text_span: TextSpanData | None = Field(None, description="Text span for this field")
...
class GroundTruthAnnotationUpdate(BaseModel):
    ...
    value: Any | None = Field(None, description="Updated value")
    annotation_data: dict[str, Any] | None = Field(None, description="Updated location data")
...
class AnnotationSuggestion(BaseModel):
    ...
    text_snippet: str | None = Field(None, description="Text snippet from document")
...
class ApproveAnnotationRequest(BaseModel):
    ...
    edited_value: Any | None = Field(None, description="Edited value (if user modified)")
