    ...
    <Shell>
      <div className="flex h-[calc(100vh-3.5rem)]">
        <div className="w-64 border-r bg-muted/5 p-4 flex flex-col gap-1">
          <h2 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider px-3 mb-2 text-primary">
            Global Settings
          </h2>
          <Button
            variant="ghost"
              ...
              <>
                <div>
                  ...
                  <p className="text-muted-foreground mt-1">
                    LLM model is configured in backend settings.
                  </p>
                </div>
                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        <div className="text-sm text-muted-foreground">
                          <p>
                            The LLM model is configured in the backend{" "}
            ...
            {activeTab === "engines" && (
              <>
                <div>
                  ...
                  <p className="text-muted-foreground mt-1">
                    Manage OCR and document analysis services.
                  </p>
                </div>
                ...
                <div className="grid gap-6">
                  <Card className="border-accent/10 bg-card">
                    <CardHeader>
                      ...
                      <CardDescription>
                        This section currently has no backend persistence.
                      </CardDescription>
                    </CardHeader>
                  </Card>
                </div>
